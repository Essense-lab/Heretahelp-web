...
import { MapPin, Users, Wrench, CreditCard } from 'lucide-react'
...
const steps = [
  ...
  {
    name: 'Secure Payment',
    description: 'Pay securely through the app only after you\'re satisfied with the completed work.',
    icon: CreditCard,
    details: [
              ...
              <div key={step.name} className="relative">
                ...
                <div className="relative z-10 bg-white">
                  <div className="text-center">
                    ...
                    <h3 className="mt-6 text-xl font-medium text-gray-900">{step.name}</h3>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        {step.details.map((detail) => (
                          <li key={detail} className="flex items-center justify-center">
                            <div className="flex-shrink-0 w-1.5 h-1.5 bg-primary rounded-full mr-2"></div>
                            {detail}
                          </li>
                        ))}
                      </ul>
